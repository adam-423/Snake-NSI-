...
Plateau = Canvas(fenetre, width = LargeurPlateau, height = HauteurPlateau, bg = "gray")
...
def remplir_case (x, y):
    ...
    Plateau.create_rectangle(OrigineCaseX1, OrigineCaseY1, OrigineCaseX2, OrigineCaseY2, fill="red")
...
def dessine_fruit():
    ...
    Plateau.create_oval(OrigineCaseX1, OrigineCaseY1, OrigineCaseX2, OrigineCaseY2, fill = "blue")
